...
- Send Discord message with NextJS app router (next-intl) - https://peturgeorgievv.com/blog/how-to-create-contact-form-with-discord-and-nextjs-free [discord-contact-form]
